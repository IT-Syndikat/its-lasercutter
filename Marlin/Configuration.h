...
#define LASER_FIRE_G2 10 // fire the laser on a G2 move, extinguish when the move ends
#define LASER_FIRE_G3 10 // fire the laser on a G3 move, extinguish when the move ends
